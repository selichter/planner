function ProfileListsController($scope, BackendService) {
  var ctrl = this;
  var lists = [];
  ctrl.lists = [];
...
ProfileListsController.$inject = ['$scope', 'BackendService']

angular
  .module("app")
  .controller('ProfileListsController', ProfileListsController)
